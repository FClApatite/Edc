...
extern touchgfx::GeneratedFont& getFont_verdana_30_1bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_verdana_40_2bpp()),
    &(getFont_verdana_30_1bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_verdana_40_2bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_verdana_30_1bpp());
        break;
    }
}
} // namespace TypedTextDatabase
